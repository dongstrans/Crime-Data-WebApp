...
<body>
    ...
    <div class="container body-content">
        @RenderBody()
        <hr />
        <h1>Kingston upon Thames</h1>
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d39811.37464170292!2d-0.32439836255185195!3d51.417552107234485!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4876093778987453%3A0x4c3f21b23e3e35ec!2sKingston%20upon%20Thames!5e0!3m2!1sen!2suk!4v1682625052035!5m2!1sen!2suk"
width="1024" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        <br><br>
        <p>Here is the list of list and totals of crimes at Kingston upon Thames.</p>
        <div class="container">
                ...
                <table class="table">
                    <?php
                        $sql = "SELECT Crime_Type_1, COUNT(Crime_Type_1) AS Crime_Type_Count
                                    ...
                                    WHERE geo_location.LSOA_Name LIKE 'Kingston%'
