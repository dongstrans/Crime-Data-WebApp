...
<head>
    ...
    <title>Richmond upon Thames</title>
...
<body>
    ...
    <div class="container body-content">
        @RenderBody()
        <hr />
        <h1>Richmond upon Thames</h1>
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d39779.362676976096!2d-0.33253706197739374!3d51.454297616308445!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48760b88237c5027%3A0xa9a7de1ab1d56e58!2sRichmond!5e0!3m2!1sen!2suk!4v1682711610753!5m2!1sen!2suk"
width="1024" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        <br><br>
        <p>Here is the list of list and totals of crimes at Richmond upon Thames.</p>
        <div class="container">
                ...
                <table class="table">
                    <?php
                        $sql = "SELECT Crime_Type_1, COUNT(Crime_Type_1) AS Crime_Type_Count
                                    ...
                                    WHERE geo_location.LSOA_Name LIKE 'Richmond%'
