...
<body>
    ...
    <div class="container body-content">
        @RenderBody()
        <hr />
        <h1>Barking and Dagenham</h1>
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d39689.63121225742!2d0.12241120307758957!3d51.557197604353085!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47d8a5b25e18c691%3A0x41185c626be67d0!2sLondon%20Borough%20of%20Barking%20and%20Dagenham!5e0!3m2!1sen!2suk!4v1682262991424!5m2!1sen!2suk"
        width="1024" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        <br><br>
        <p>Here is the list of list and totals of crimes at Barking and Dagenham.</p>
        <div class="container">
                ...
                <table class="table">
                    <?php
                        $sql = "SELECT Crime_Type_1, COUNT(Crime_Type_1) AS Crime_Type_Count
                                    ...
                                    WHERE geo_location.LSOA_Name LIKE 'Barking%'
