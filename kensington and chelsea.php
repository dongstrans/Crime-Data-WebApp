...
<head>
    ...
    <title>Kensington and Chelsea</title>
...
<body>
    ...
    <div class="container body-content">
        @RenderBody()
        <hr />
        <h1>Kensington and Chelsea</h1>
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d39736.18221776875!2d-0.2304852612024885!3d51.50383336112101!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48760ff7f26a3943%3A0x40eae2da2ec6730!2sRoyal%20Borough%20of%20Kensington%20and%20Chelsea%2C%20London!5e0!3m2!1sen!2suk!4v1682624689112!5m2!1sen!2suk"
width="1024" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        <br><br>
        <p>Here is the list of list and totals of crimes at Kensington and Chelsea.</p>
        <div class="container">
                ...
                <table class="table">
                    <?php
                        $sql = "SELECT Crime_Type_1, COUNT(Crime_Type_1) AS Crime_Type_Count
                                    ...
                                    WHERE geo_location.LSOA_Name LIKE 'Kensington%'
