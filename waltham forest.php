...
<body>
    ...
    <div class="container body-content">
        @RenderBody()
        <hr />
        <h1>Waltham Forest</h1>
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d79307.49958419299!2d-0.10068171610330076!3d51.59830374111922!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48761de1f6301091%3A0x40eae2da2ec68d0!2sLondon%20Borough%20of%20Waltham%20Forest!5e0!3m2!1sen!2suk!4v1682713041223!5m2!1sen!2suk"
width="1024" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        <br><br>
        <p>Here is the list of list and totals of crimes at Waltham Forest.</p>
        <div class="container">
                ...
                <table class="table">
                    <?php
                        $sql = "SELECT Crime_Type_1, COUNT(Crime_Type_1) AS Crime_Type_Count
                                    ...
                                    WHERE geo_location.LSOA_Name LIKE 'Waltham%'
