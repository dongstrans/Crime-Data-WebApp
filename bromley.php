...
<body>
    ...
    <div class="container body-content">
        ...
        <hr />
        <h1>Bromley</h1>
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d79662.17599687177!2d-0.055344678981971825!3d51.39491442072627!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47d8a9f5929e089d%3A0xf484cf0c2f12f0f6!2sBromley!5e0!3m2!1sen!2suk!4v1682537126377!5m2!1sen!2suk"
width="1024" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        <br><br>
        <p>Here is the list of list and totals of crimes at Bromley.</p>
        <div class="container">
                ...
                <table class="table">
                    <?php
                        $sql = "SELECT Crime_Type_1, COUNT(Crime_Type_1) AS Crime_Type_Count
                                    ...
                                    WHERE geo_location.LSOA_Name LIKE 'Bromley%'
