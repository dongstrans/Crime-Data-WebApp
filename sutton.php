...
<body>
    ...
    <div class="container body-content">
        ...
        <hr />
        <h1>Sutton</h1>
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d39862.52436267292!2d-0.24629501346963995!3d51.35879992264986!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4875e280183c1fe7%3A0xda26308044d5ef66!2sSutton!5e0!3m2!1sen!2suk!4v1682712404051!5m2!1sen!2suk"
width="1024" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        <br><br>
        <p>Here is the list of list and totals of crimes at Sutton.</p>
        <div class="container">
                ...
                <table class="table">
                    <?php
                        $sql = "SELECT Crime_Type_1, COUNT(Crime_Type_1) AS Crime_Type_Count
                                    ...
                                    WHERE geo_location.LSOA_Name LIKE 'Sutton%'
