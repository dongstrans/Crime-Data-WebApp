...
<body>
    ...
    <div class="container body-content">
        ...
        <hr />
        <h1>Barnet</h1>
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d39601.74507205919!2d-0.18807490000000002!3d51.65783945!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487617479f5d9053%3A0xa1185c8d1917f90!2sBarnet!5e0!3m2!1sen!2suk!4v1682535969794!5m2!1sen!2suk"
        width="1024" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        <br><br>
        <p>Here is the list of list and totals of crimes at Barnet.</p>
        <div class="container">
                ...
                <table class="table">
                    <?php
                        $sql = "SELECT Crime_Type_1, COUNT(Crime_Type_1) AS Crime_Type_Count
                                    ...
                                    WHERE geo_location.LSOA_Name LIKE 'Barnet%'
